...
Independence: The data points are collected independently; one person's data doesn't influence another's.

Homoscedasticity (Constant Variance): The "spread" or "scatter" of the errors is the same across all levels of your predictors.

Normality: For any given value of X, the errors (residuals) should follow a bell-shaped curve.
